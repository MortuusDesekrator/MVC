...
<div class="contenedor">
  ...
  <fieldset>
    <center>
      <label>
        Divisas en Bolivares
      </label>
      <input type="number" name="bolivares" required min="70000" minlength="5">
  ...
  <fieldset>
    <center>
      <label>
        Cantidiad de venta en Bolivares
      </label>
      <input type="number" name="bolivares" required min="0">
  ...
  <fieldset>
    <center>
     ...
     <input type="button" value="convertir" id="button" onclick="currencyCalculator(calcular.dolares.value)">
     <br>
      <label>
        <br>
      Venezuela
...
<script src="<?php echo constant('URL'); ?>public/js/vender.js"></script>
